...
<aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="assets/images/users/<?php echo $masterImage;?>" alt="user-img" class="img-circle"><span class="hide-menu"><?php echo $firstName." ".$lastName ?></span></a>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-calendar"></i><span class="hide-menu">Appointment</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="Groomer-schedule.php">Groomer Schedule</a></li>
                                <li><a href="book-appointment.php">Book Appointment</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-user-md"></i><span class="hide-menu">Groomers</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="Groomers.php">All Groomers</a></li>
                                <li><a href="add-Groomer.php">Add Groomer</a></li>
                                <li><a href="edit-Groomer.php">Edit Groomer</a></li>
                                <li><a href="Groomer-profile.php">Groomer Profile</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-people"></i><span class="hide-menu">Pets</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="Pets.php">All Pets</a></li>
                                <li><a href="add-Pet.php">Add Pets</a></li>
                                <li><a href="edit-Pet.php">Edit Pets</a></li>
                                <li><a href="Pet-profile.php">Pet Profile</a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-rupee-sign"></i><span class="hide-menu">Payments</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="Pet-invoice.php">Invoice</a></li>
                            </ul>
                        </li>
